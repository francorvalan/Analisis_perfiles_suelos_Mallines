...
Se analizaron `r nrow(horizons) ` capas de suelos, localizadas en  `r length(horizons)` perfiles, comprendiendo distintas profundidades, abarcando desde la superfie hasta `r max(horizons$bottom,na.rm=T)`. 
